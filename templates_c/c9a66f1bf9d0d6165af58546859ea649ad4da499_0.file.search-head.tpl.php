...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_5e73887cf30747_75013157',
...
function content_5e73887cf30747_75013157 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- Masthead -->
...
/app/search.php" method="post" accept-charset="UTF-8" id="job_search_form">
          <div class="form-row">
...
" class="form-control form-control-lg" placeholder="Country...">
            ...
            <div class="col-12 col-md-3">
              <button type="button" class="btn btn-block btn-lg btn-primary" onclick="isSearch()">Search</button>
            </div>
          </div>
        </form>
      </div>
